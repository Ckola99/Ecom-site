...
const CartModal = ({ isOpen, handleCloseModal }) => {
	...
	return isOpen ? (
		...
		>
			<div
				className="bg-white p-8 rounded-lg shadow-lg w-[327px] h-[488px] mx-auto mt-[80px] flex flex-col justify-between"
			...
			>
				...
				<div className="flex flex-col justify-between h-auto gap-5">
				...
				<Link to="checkout">
					<button
						onClick={handleCloseModal}
						className="w-full h-[48px] bg-main-orange text-white text-transform: uppercase text-[13px] font-bold tracking-[1px]"
					>
						checkout
					</button>
				</Link>
